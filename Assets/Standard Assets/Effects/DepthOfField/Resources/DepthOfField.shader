Shader "Hidden/DepthOfField/DepthOfField"
{
    ...
    CGINCLUDE
        ...
        v2f vert_d(appdata_img v)
        {
            ...
            half2 uv = UnityStereoScreenSpaceUVAdjust(v.texcoord, _MainTex_ST);
        ...
        v2fBlur vertBlurPlusMinus(appdata_img v)
        {
            ...
            o.uv.xy = uv.xy;
            o.uv01 =  uv.xyxy + _Offsets.xyxy * float4(1,1, -1,-1) * _MainTex_TexelSize.xyxy / 6.0;
            o.uv23 =  uv.xyxy + _Offsets.xyxy * float4(2,2, -2,-2) * _MainTex_TexelSize.xyxy / 6.0;
            o.uv45 =  uv.xyxy + _Offsets.xyxy * float4(3,3, -3,-3) * _MainTex_TexelSize.xyxy / 6.0;
            o.uv67 =  uv.xyxy + _Offsets.xyxy * float4(4,4, -4,-4) * _MainTex_TexelSize.xyxy / 6.0;
            o.uv89 =  uv.xyxy + _Offsets.xyxy * float4(5,5, -5,-5) * _MainTex_TexelSize.xyxy / 6.0;
            return o;
        }
